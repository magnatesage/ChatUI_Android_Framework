...
object AppConstants {
     ...
     */
    const val ROUNDED_CORNERS_RECT = "style1"
    const val SQUARE_RECT = "style2"
    const val SEMI_ROUNDED_CORNERS_RECT = "style3"
    const val OVAL_RECT = "style4"
    const val CIRCLE_RECT = "style5"
